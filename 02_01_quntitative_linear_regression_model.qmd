---
title: "Quntitative Linear Regression"
description: "This chapter explores linear regression as a core statistical method for modeling relationships between variables. It begins with simple linear regression, examining how a single predictor relates to an outcome, before extending to multiple linear regression, where several predictors are combined to improve explanatory power. The chapter then introduces interaction effects, showing how the relationship between a predictor and the outcome can change depending on the value of another variable. Finally, it covers hierarchical linear regression, a model-building strategy in which predictors are entered in theoretically guided blocks, allowing researchers to assess the incremental contribution of each set of variables to the explained variance. Throughout, emphasis is placed on interpretation of coefficients, model comparison, and practical application."
